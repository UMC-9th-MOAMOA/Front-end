  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-25">
      ...
      <div
        ...
        className="relative flex h-245 w-full flex-col items-center gap-20 rounded-xl bg-[var(--color-white)] px-20 pt-28 pb-20"
      >
        {/* title */}
        <p
          id={titleId}
        ...
        <Button
          type="button"
          onClick={onConfirm}
          className="flex h-50 w-full items-center justify-center rounded-lg bg-[var(--color-moamoa-300)]"
        >
