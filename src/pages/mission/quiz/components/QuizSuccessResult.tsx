...
export default function QuizSuccessResult({
  ...
  return (
    <div className="flex min-h-screen flex-col items-center">
      ...
      <div className="z-20 mt-234 w-full rounded-[20px] bg-white px-25 pb-19">
        ...
        {questionType === "ox" && (
          <div className="mt-15 flex items-center justify-center">
            <div className="flex h-80 w-82 items-center justify-center rounded-[10px] border border-blue-400 bg-moamoa-100">
      ...
      <div className="mt-auto flex w-full flex-col items-center px-25 pt-22 pb-42">
